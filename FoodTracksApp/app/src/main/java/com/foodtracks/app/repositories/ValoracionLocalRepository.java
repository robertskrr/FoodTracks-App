...
/**
 * Repositorio encargado de gestionar la persistencia y consultas de la colección "valoraciones_locales" en
 * Firestore. Centraliza el acceso a datos para las valoraciones de los locales por parte de clientes.
 *
 * @author Robert
 * @since 26/03
 */
